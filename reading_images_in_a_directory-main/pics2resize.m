 ...
 inputDir = 'picsjpg/'; % this is the input directory
 outputDir = 'picssamesize/';% after processing all the jpg images will be stored into png format in this directory
